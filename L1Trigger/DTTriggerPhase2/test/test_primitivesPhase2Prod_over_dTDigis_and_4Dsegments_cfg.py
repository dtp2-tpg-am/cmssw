...
process.load("L1Trigger.DTTriggerPhase2.dtTriggerPhase2PrimitiveDigis_cfi")
#test for run2_data
process.dtTriggerPhase2PrimitiveDigis.cmssw_for_global = cms.untracked.bool(False) 
process.dtTriggerPhase2PrimitiveDigis.global_coords_filename = cms.FileInPath('L1Trigger/DTTriggerPhase2/data/global_coord_perp_x_phi0_run2_data.txt')
process.dtTriggerPhase2PrimitiveDigis.shift_theta_filename = cms.FileInPath('L1Trigger/DTTriggerPhase2/data/theta_shift_run2_data.txt')
